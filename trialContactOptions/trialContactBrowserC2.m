...
function trialContactBrowserC2(array, contacts, contactsAuto, params, varargin)
if nargin <4
    if nargin<=2
        error('Autocurator contacts missing. Please use regular autocurator.')
    end
    ...
    if  nargin == 1
        ...
        params.contactsAutoname = inputname(3);
    ...
    set(fbutton,'ClickedCallback',['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''next'')'])
    set(bbutton,'ClickedCallback',['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''last'')'])
    set(abutton,'ClickedCallback',['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''add'')'])
    set(dbutton,'ClickedCallback',['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''del'')'])
    set(rbutton,'ClickedCallback',['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''recalc'')'])
    set(sbutton,'ClickedCallback',['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''save'')'])
    set(vbutton,'ClickedCallback',['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''videoOn'')'])
    
    set(flagToggle,'OnCallback',   ['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''flagOn'')'])
    set(flagToggle,'OffCallback',  ['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''flagOff'')'])
    set(floatToggle,'OnCallback',  ['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''floatOn'')'])
    set(floatToggle,'OffCallback', ['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''floatOff'')'])
    set(zoomToggle,'OnCallback',   ['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''zoomOut'')'])
    set(zoomToggle,'OffCallback',  ['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''zoomIn'')'])
    
    % Setup menus
    m1=uimenu(hParamBrowserGui,'Label','Time Period','Separator','on');
    uimenu(m1,'Label','All'                          ,'Callback', ['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''all'')']);
    uimenu(m1,'Label','Contacts Only'                ,'Callback', ['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''contactsOnly'')']);
    uimenu(m1,'Label','Exclude Contacts'             ,'Callback', ['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''excludeContacts'')']);
    uimenu(m1,'Label','Pole Presentation to Decision','Callback', ['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''poleToDecision'')']);
    uimenu(m1,'Label','First Contact to Decision'    ,'Callback', ['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''contactToDecision'')']);
    uimenu(m1,'Label','Post Decision'                ,'Callback', ['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''postDecision'')']);
    uimenu(m1,'Label','Post Pole'                    ,'Callback', ['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''postPole'')']);
    uimenu(m1,'Label','Abritrary Range'              ,'Callback', ['trialContactBrowserC1(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''arbitrary'')']);
    
    m2=uimenu(hParamBrowserGui,'Label','Adjust parameters','Separator','on');
    uimenu(m2,'Label','Plots'   ,'Callback',['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''adjPlots'')']);
    uimenu(m2,'Label','Spikes'  ,'Callback',['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''adjSpikes'')']);
    uimenu(m2,'Label','Contacts','Callback',['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''adjContacts'')']);
    uimenu(m2,'Label','Trial Range','Callback',['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''adjTrials'')']);
    
    uimenu(hParamBrowserGui,'Label','Jump to sweep','Separator','on','Callback',['trialContactBrowserC2(' params.arrayname ',' params.contactsname ',' params.contactsAutoname ', params,''jumpToSweep'')']);
    ...
    setappdata(hParamBrowserGui, 'contactsAuto', contactsAuto);
    ...
    for j = 1:length(varargin);
        ...
        switch argString
            ...
            case 'videoOn'
                ...
                try 
                    brushData = get(findobj('Tag','t_d'),'BrushData');
                    if iscell(brushData)
                        if sum(brushData{1}) == 0
                            warning('No datapoints found, please brush data points before calling video')
                        end
                        brushDataIdx = find(brushData{1} == 4);
                    else
                        if sum(brushData) == 0
                            warning('No datapoints found, please brush data points before calling video')
                        end
                        brushDataIdx = find(brushData == 4);
                    end
                    fr = round(1/array.trials{params.sweepNum}.whiskerTrial.framePeriodInSec);
                    toPlay = round(array.trials{params.sweepNum}.whiskerTrial.time{1}(brushDataIdx)*fr)+1;
...
if isempty(cW)==1
    ...
    try
        ...
        cindAuto=contactsAuto{params.sweepNum}.contactInds{1};
    catch
        cind = [];
        cindAuto=[];
    end
    ...
    plot(cW.time{1}(commonCind),cW.distanceToPoleCenter{1}(commonCind),'.b')
    plot(cW.time{1}(fnegCind),cW.distanceToPoleCenter{1}(fnegCind),'.c','MarkerSize',12)
    plot(cW.time{1}(fposCind),cW.distanceToPoleCenter{1}(fposCind),'.r','MarkerSize',12)
